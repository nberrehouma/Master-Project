...
public class GrammarSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GrammarPackage.GRAMMAR: {
				...
				if (result == null) result = caseNamed(grammar);
			...
			case GrammarPackage.LHS: {
				LHS lhs = (LHS)theEObject;
				T result = caseLHS(lhs);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrammarPackage.RHS: {
				RHS rhs = (RHS)theEObject;
				T result = caseRHS(rhs);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrammarPackage.EMBEDDING: {
				Embedding embedding = (Embedding)theEObject;
				T result = caseEmbedding(embedding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrammarPackage.CONNEXION_INSTRUCTION: {
				ConnexionInstruction connexionInstruction = (ConnexionInstruction)theEObject;
				T result = caseConnexionInstruction(connexionInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Connexion Instruction</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Connexion Instruction</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConnexionInstruction(ConnexionInstruction object) {
		return null;
	}
