	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GraphPackage.GRAPH: {
				...
				if (result == null) result = caseNamed(graph);
			...
			case GraphPackage.TYPED: {
				...
				if (result == null) result = caseNamed(typed);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphPackage.NODE: {
				...
				if (result == null) result = caseTyped(node);
				if (result == null) result = caseNamed(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphPackage.EDGE: {
				...
				if (result == null) result = caseTyped(edge);
				if (result == null) result = caseNamed(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
