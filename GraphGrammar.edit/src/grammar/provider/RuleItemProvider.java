...
/**
 * This is the item provider adapter for a {@link grammar.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrammarPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrammarPackage.Literals.RULE__PRIORITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrammarPackage.Literals.RULE__LHS);
			childrenFeatures.add(GrammarPackage.Literals.RULE__RHS);
			childrenFeatures.add(GrammarPackage.Literals.RULE__EMBEDDING_MECHANISM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__LHS,
				 GrammarFactory.eINSTANCE.createLHS()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__RHS,
				 GrammarFactory.eINSTANCE.createRHS()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__EMBEDDING_MECHANISM,
				 GrammarFactory.eINSTANCE.createEmbedding()));
	}
