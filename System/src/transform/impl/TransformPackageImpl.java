...
public class TransformPackageImpl extends EPackageImpl implements TransformPackage {
	 ...
	 * @see transform.TransformPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTransformation_Hote() {
	 ...
	 * @generated
	 */
	public EReference getTransformation_Grammar() {
	...
	public void createPackageContents() {
		...
		createEReference(transformationEClass, TRANSFORMATION__HOTE);
		createEReference(transformationEClass, TRANSFORMATION__GRAMMAR);
	}
	...
	public void initializePackageContents() {
		...
		transformationEClass.getESuperTypes().add(theGraphPackage.getNamed());

		// Initialize classes, features, and operations; add parameters
		initEClass(transformationEClass, Transformation.class, "Transformation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransformation_Hote(), theGraphPackage.getGraph(), null, "hote", null, 0, 1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransformation_Grammar(), theGrammarPackage.getGrammar(), null, "grammar", null, 0, 1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
